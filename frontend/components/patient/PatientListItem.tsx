  ...
  return (
    <div className={`${isOpen ? 'bg-[#EEEEEE]' : 'bg-[#FAFAFA]'}`}>
      ...
      >
        ...
        <div className="text-base text-center">{patient.id_number}</div>
        ...
        <div className="flex justify-end items-center gap-6">
          ...
          <button
            onClick={(e) => {
              e.stopPropagation();
              router.push(`/patient/${patient.id_number}/ehr/create`);
            }}
      ...
      {isOpen && <PreviousEHRs patientId={patient.id_number} />}
    </div>
  );
} 